...
def get_summary_from_text_file(rawtext):
    ...
    #
    text = rawtext
    stop_words = open("C:/Users/HP/Downloads/TextSummarization/Summarizer/stopwords.txt",'r',encoding="utf-8").read()
    word_endings = open("C:/Users/HP/Downloads/TextSummarization/Summarizer/word_endings.txt",'r',encoding='utf-8').read() 
