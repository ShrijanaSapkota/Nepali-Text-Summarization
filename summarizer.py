...
def get_summary_from_text_file(rawtext):
    ...
    text = rawtext
    stop_words = open(
        "G:/project/TextSummarization/Summarizer/stopwords.txt", 'r', encoding="utf-8").read()
    word_endings = open(
        "G:/project/TextSummarization/Summarizer/word_endings.txt", 'r', encoding='utf-8').read()
    ...
    # open('G:/project/TextSummarization/Summarizer\Output\\output.txt', 'w',encoding="utf-8").write(summarized_text)
